  ...
  return (
    <section>
      <div className="mb-4 flex items-end justify-between">
        <div>
          <h2 className="text-xl font-bold tracking-[-0.02em] text-slate-900">Dịch vụ nhanh</h2>
          <p className="mt-1.5 text-sm text-slate-500">Chọn dịch vụ bạn cần để bắt đầu.</p>
        </div>
