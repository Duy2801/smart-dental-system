  ...
  return (
    <section>
      <div className="mb-4 flex items-center justify-between">
        <h2 className={T.sectionTitle}>Đội ngũ chuyên gia</h2>
            ...
            <div className="min-w-0 flex-1">
              <div className="flex items-start justify-between gap-2">
                <div>
                  ...
                  <p className={`mt-1 ${T.bodySm}`}>{doctor.specialty}</p>
                </div>
                <span className="text-xs font-bold text-amber-500">★ {doctor.rating}</span>
              </div>
              <p className={`mt-2 ${T.bodySm}`}>{doctor.experience} kinh nghiệm</p>
              <Link
