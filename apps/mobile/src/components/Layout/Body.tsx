...
type HeaderProps = {
  ...
  headerLeft?:
    | React.ReactNode
    | (({ navigation }: { navigation: any }) => React.ReactNode);
  headerRight?:
    | React.ReactNode
    | (({
        navigation,
...
const Header = (props: HeaderProps) => {
  const { title, backgroundColor, headerLeft, headerRight, headerTitleStyle } =
    props;
  ...
  return (
    ...
    >
      ...
      >
        {typeof resolvedHeaderLeft === 'function'
          ? resolvedHeaderLeft({ navigation })
          : resolvedHeaderLeft}
      </View>
