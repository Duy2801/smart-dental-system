...
export default function PatientRecordsPage() {
  ...
  useEffect(() => {
    ...
    // Load patient info + all medical records for this doctor, then filter by patientId
    Promise.all([
      apiClient.get<PatientBasic>(
      ...
      .then(([ptRes, recRes]) => {
        ...
        setRecords(
          recRes.data.filter((r) => r.patientId === id),
        );
      })
      .catch(() => setError("Không thể tải dữ liệu hồ sơ bệnh nhân."))
            ...
            <div className="mb-6 flex items-center gap-4 rounded-2xl border border-border bg-white p-5 shadow-sm">
              ...
              <div>
                ...
                <div className="mt-1 flex flex-wrap items-center gap-2 text-sm text-muted-foreground">
                  ...
                  {patient.age && <span>{patient.age} tuổi</span>}
                  {patient.phone && (
                ...
                {records.map((r, idx) => (
                  <div
                    ...
                    className={cn(
                      ...
                      idx !== records.length - 1 && "border-b border-border/50",
                    )}
                  >
